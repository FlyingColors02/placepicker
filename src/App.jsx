...
const storedPickedPlaces = storedIds.map(id => AVAILABLE_PLACES.find(place => place.id ==  id));
...
function App() {
  ...
  const [pickedPlaces, setPickedPlaces] = useState(storedPickedPlaces);
	const [sortedPlaces, setSortedPlace] = useState([]);
